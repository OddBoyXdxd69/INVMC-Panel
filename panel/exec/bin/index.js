...
program
    .version("0.1.0-beta6")
    .description("Command Line Interface for the INVMC Panel");
...
program
    ...
    .action(async () => {
        ...
        try {
            const imagesIndexResponse = await axios.get('https://raw.githubusercontent.com/invmclabs/images_v2/main/seed/0.1.0-beta2.json');
...
program
    ...
    .action(async () => {
        ...
        async function main() {
            log.init('create a new *admin* user for the invmc panel:')
