...
/**
 * Default HTTP GET route that provides basic invmc-invmc-daemon status information including Docker connectivity
 * and system info. It performs a health check on Docker to ensure it's running and accessible, returning
 * the invmc-invmc-daemon's status and any pertinent Docker system information in the response.
 */
...
setTimeout(function (){
  server.listen(port, () => {
    log.info('INVMC is listening on port ' + port);
  });
}, 2000);
